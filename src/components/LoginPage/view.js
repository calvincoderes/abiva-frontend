              ...
              <Row>
                <Col span={24}>
                  <FormItem
                    ...
                    required
                  >
                    {props => <Input {...props} autoComplete='off' prefix={<UserOutlined style={{ color: '#074EE8' }} />} placeholder='' size='large' />}
                  </FormItem>
                </Col>
                <Col span={24}>
                  <FormItem
                    ...
                    required
                  >
                    {props => <Input.Password {...props} prefix={<LockOutlined style={{ color: '#074EE8' }} />} placeholder='' size='large' />}
                  </FormItem>
                </Col>
                <Col className='center-right-vh' span={24}>
                  <Link to='/forgot-password'>
                    <Button className='pr-0' type='link'>Forgot Password?</Button>
                  </Link>
                </Col>
              </Row>
              <Row className='mt-5'>
