  ...
  <ViewComponent>
    {({ formik, columns, data, handleTableOnChange }) => (
      <Styled>
        <Row>
          <Col span={24}>
            <p style={{ fontSize: '24px', color: '#111111' }}>Add Subject</p>
          </Col>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={24}>
            <p style={{ color: '#111111', fontSize: '16px' }}>Create Subject</p>
          </Col>
          <Col span={4}>
            <FormItem
              formik={formik}
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={24}>
            <p style={{ color: 'var(--black)', fontSize: '16px' }}>Assign Books/Content <i style={{ color: 'var(--grey)', fontSize: '15px' }}>(optional)</i></p>
          </Col>
          <Col span={24}>
