  ...
  <ViewComponent mainFormik={mainFormik}>
    {({
      ...
      <Styled>
        ...
        <Spin spinning={state.updatedModule.status === 1}>
            ...
            <Row gutter={[10, 10]} className='mb-10'>
              <Col span={22}>
                <Tabs onChange={handleTabsChanged} defaultActiveKey={0} tabPosition='top' style={{ height: 300 }}>
                  {tabs && tabs.module && tabs.module.map((t, i) => (
                    <TabPane tab={`Page ${t.page}`} key={i}>
                      ...
                      {tabs.module[i].is_content && <Row gutter={[10, 10]}>
                        ...
                        <Col span={24}>
                          ...
                          <Wysiwyg index={parseInt(i)} initialDescription={t.content_description} currentTab={currentTab} handleOnChange={handleOnChange} />
                        </Col>
                      </Row>}
              ...
              <Col className='mt-2' span={24}>
                <Row>
                  <Col className='center-right-vh' span={24}>
                    <Button
                      disabled={state.updatedModule.status === 1}
                      type='primary'
                      size='large'
                      htmlType='submit'
                      name='submit'
