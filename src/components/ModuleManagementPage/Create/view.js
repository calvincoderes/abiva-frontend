          ...
          <Col span={24}>
            <Row>
              ...
              >
                <Row gutter={[20, 20]}>
                  <Col span={24}>
                    <p style={{ fontSize: '24px', color: '#111111' }}>Add Module</p>
                  </Col>
                  <Col span={24}>
                    <Steps current={current}>
                      <Step title='School/Organization' description='Select School/Organization' />
                      <Step title='Teacher' description='Assign teacher to manage this module' />
                      <Step title='Create Module' description='Create one or more pages of module' />
                    </Steps>
                  </Col>
                  <Col span={24}>
