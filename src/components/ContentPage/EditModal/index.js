            ...
            <Styled>
              {selectedData && selectedData !== null && Object.keys(selectedData).length > 0 && <div className='container'>
                <form method='post' onSubmit={formik.handleSubmit} noValidate>
                  <Row>
                    <Col span={24}>
                      <Title level={2}>Update Content Information #{selectedData.id}</Title>
                    </Col>
                  </Row>
                      ...
                      <Row>
                        <Col span={24}>
                          ...
                          >
                            ...
                            {/* Extra handle if cover photo is image link */}
                            {image && image.match(/\.(jpeg|jpg|png|gif)/g) === null && <Image src='/assets/images/default-lg-height.png' preview={false} />}

                            {/* Extra handle if cover photo is not image link */}
                            {image && image.match(/\.(jpeg|jpg|png|gif)/g) !== null && <img src={image} alt='' style={{ width: '100%' }} />}
                          </Upload>
